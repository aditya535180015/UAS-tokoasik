...
const insframeRouterAPI = require('./routes/tokoasikAPI')
const insframeContent = require('./routes/tokoasikContent')
const insframeAuth = require('./routes/tokoasikAuth')
const insframeProfile = require('./routes/tokoasikProfile')
